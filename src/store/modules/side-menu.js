...
export default {
  ...
  actions:{
    async get({dispatch,commit},query){
      ...
      let response = await axios.get('side-menus',{params:query});
    ...
    async create({dispatch,commit},data){
      let response = await axios.post('side-menu/store',data);
      dispatch('get');
      return response.data;
    },
    async edit({dispatch,commit},ID){
      //console.log(ID)
      let response = await axios.get('side-menu/edit/'+ID);
      return response.data
    },
    async update({dispatch,commit},data){
      let response = await axios.post('side-menu/update',data);
      dispatch('get');
      return response.data;
    },
    
    async delete({dispatch,commit},data){
      let response = await axios.post('side-menu/delete', data);
      dispatch('get');
      return response.data
    },
  },
